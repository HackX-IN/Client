        ...
        // }
            ...
            if(response.data.success){
                ...
                if(response1.data.status){
                    console.log("Get phon number>>>:::",`${countryCode+mobileNumber}`)
            ...
            setIsLoading(false)
                ...
                navigation.navigate('OTPScreen',{mobileNumber:`${countryCode}${mobileNumber}`,confirm: confirmation,})
                    } else {
            setIsLoading(false)
...
return(
    ...
    <View style={styles.container}>
        ...
        <CountryPicker
            ...
            <Text style={styles.signupText} onPress={()=>navigation.navigate('RegisterScreen')}>You don't have an account? Sign Up</Text>
            </View>
    </View>
